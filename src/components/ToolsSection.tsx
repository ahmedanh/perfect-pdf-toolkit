      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Try our most popular tools to transform your PDF workflow
          </p>
        </div>
        ...
        <Tabs defaultValue="edit" className="w-full max-w-4xl mx-auto">
          ...
          <TabsContent value="edit" className="p-6 bg-white rounded-xl shadow-md border border-gray-100">
            ...
            <div className="flex flex-col items-center justify-center p-8 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 mb-6">
              ...
              <p className="text-gray-600 mb-2">Drop your PDF file here or</p>
          ...
          <TabsContent value="convert" className="p-6 bg-white rounded-xl shadow-md border border-gray-100">
          ...
          <TabsContent value="sign" className="p-6 bg-white rounded-xl shadow-md border border-gray-100">
          ...
          <TabsContent value="compress" className="p-6 bg-white rounded-xl shadow-md border border-gray-100">
